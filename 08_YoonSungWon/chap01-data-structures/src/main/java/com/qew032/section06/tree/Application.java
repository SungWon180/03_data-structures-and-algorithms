...
/*
 *  자바 컬렉션의 TreeSet, TreeMap이 트리 구조를 활용히고 있음.
 *  내부적으로 레드-블랙 트리로 구현되어 있음.
 *  -> 데이터가 정렬된상태를 유지하면서도 검색,삽입, 삭제 시 O(log n) 성능 보장
 *
 * */
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // 키(String) 오름차순(기본 정렬)으로 정렬되는 TreeMap생성
        ...
        System.out.println("첫 번째 key : " + map.lastKey());
    }
